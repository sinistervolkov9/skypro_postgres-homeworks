...
-- 2. из таблицы orders идентификатор заказа,
-- идентификатор заказчика, вес и страну отгрузки.
-- Заказ отгружен в страны, начинающиеся на 'P'.
-- Результат отсортирован по весу (по убыванию).
...
-- 3. имя, фамилию и телефон сотрудников,
-- у которых в данных отсутствует регион (см таблицу employees)
...
-- количества поставщиков в стране
